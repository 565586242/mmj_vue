  ...
  <div class="shop_details">
    <div class="address_list_box">
      ...
      <div class="swiper_banner">
        ...
        <h5>
					...
					<p><img src="../../assets/icon_zeng@2x.png" class="">{{goodsInfo.coupon}}</p>
				</h5>
      </div>
      <div class="details_top">
        <h5>
          <span>规格</span>
          <b>{{goodsInfo.goods?goodsInfo.goods.goods_specifications:'无'}}</b>
        </h5>
				<h5>
				  <span>物流无法到达地区</span>
    ...
    <div class="details_footer">
      <div class="details_car">
        <input :disabled="!$route.query.type" type="button" value="立即购买" @click="isblock=true" />
      </div>
    </div>
    <!-- 购买弹窗 -->
