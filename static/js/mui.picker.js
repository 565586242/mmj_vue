...
var picker = function($, window, document, undefined) {
	...
	Picker.prototype.setItems = function(items) {
		...
		self.items.forEach(function(item) {
			if (item !== null && item !== undefined) {
				buffer.push('<li style="background-color: #fff;width: 100%;height: 100%;position: absolute;text-align: center;vertical-align: middle;-webkit-backface-visibility: hidden;backface-visibility: hidden;overflow: hidden;box-sizing: border-box;font-size: 16px;color: #888;padding: 0px 8px;white-space: nowrap; -webkit-text-overflow: ellipsis;text-overflow: ellipsis;overflow: hidden;cursor: default;">' + (item.text || item) + '</li>');
